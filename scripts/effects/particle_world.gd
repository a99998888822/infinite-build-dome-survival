...
const PROFILE_DEFINITIONS: Dictionary = {
	...
	"explosion_wave": {
		...
		"travel_distance": Vector2(38.0, 60.0),
		"spread_radians": TAU,
		"initial_radius": 3.0,
		"alpha": 0.95,
		"shape": "circle",
	...
	"lightning_impact": {
		...
		"lifetime": Vector2(0.10, 0.26),
		"travel_distance": Vector2(80.0, 200.0),
		"spread_radians": TAU,
		"initial_radius": 4.0,
		"alpha": 1.0,
		"shape": "square",
