...
const PROFILE_DEFINITIONS: Dictionary = {
	...
	"fire_pool_flame": {
		...
		"fire_distribution": "triangle",
		"fire_half_width": 16.0,
		"fire_height": 180.0,
		"fire_rise_multiplier": 2.2,
		"fire_edge_power": 0.85,
		"fire_center_lifetime": Vector2(0.90, 1.50),
		"fire_edge_lifetime": Vector2(0.36, 0.70),
		"fire_mid_color": Color(1.0, 0.66, 0.06, 1.0),
		"fire_end_color": Color(1.0, 0.94, 0.62, 1.0),
	},
	"fire_pool_base": {
		...
		"fire_distribution": "triangle",
		"fire_half_width": 17.0,
		"fire_height": 128.0,
		"fire_rise_multiplier": 1.8,
		"fire_edge_power": 0.8,
		"fire_center_lifetime": Vector2(0.80, 1.24),
		"fire_edge_lifetime": Vector2(0.32, 0.60),
	...
	"fire_pool_tongue": {
		...
		"fire_edge_power": 0.9,
		"fire_center_lifetime": Vector2(0.96, 1.56),
		"fire_edge_lifetime": Vector2(0.36, 0.68),
	...
	"fire_pool_core": {
		...
		"fire_distribution": "triangle",
		"fire_half_width": 13.0,
		"fire_height": 184.0,
		"fire_rise_multiplier": 2.2,
		"fire_edge_power": 0.95,
		"fire_center_lifetime": Vector2(0.84, 1.32),
		"fire_edge_lifetime": Vector2(0.28, 0.56),
	...
	"fire_pool_ember": {
		...
		"fire_edge_power": 1.0,
		"fire_center_lifetime": Vector2(0.80, 1.36),
		"fire_edge_lifetime": Vector2(0.28, 0.52),
		"fire_mid_color": Color(1.0, 0.76, 0.12, 1.0),
	...
	"steam_burst": {
		"count": 28,
		"speed": Vector2(16.0, 48.0),
		"gravity": Vector2(0.0, -1.0),
		"gravity_strength": Vector2(8.0, 24.0),
		"drag": Vector2(12.0, 32.0),
		"size_min": Vector2(3.0, 3.0),
		"size_max": Vector2(7.0, 7.0),
		"lifetime": Vector2(0.35, 0.72),
		"spread_radians": PI,
		"initial_radius": 5.0,
		"alpha": 0.62,
		"shape": "square",
		"glow": 0.20,
		"colors": [Color(0.78, 0.86, 0.90, 1.0), Color(0.92, 0.96, 1.0, 1.0), Color(0.62, 0.72, 0.80, 1.0)],
	},
	"lightning_core": {
		"count": 3,
