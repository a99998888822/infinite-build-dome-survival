...
def build():
    ...
    module_path=OUT.parent/'main_menu_preview_v1'/'build_preview.py'
    spec=importlib.util.spec_from_file_location('menu_study',module_path)
    menu=importlib.util.module_from_spec(spec)
    spec.loader.exec_module(menu)
    ui=menu.make_ui()
    ui.save(OUT/'menu-overlay-v2.png')
