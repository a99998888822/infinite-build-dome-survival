...
| 工程基础设施 | 目录结构、Autoload、调试工具 | DataRegistry/GameGlobal | 性能统计、配置热重载、自动化测试 |
...
2. 建筑设计：军械工坊、遗物档案馆、利刃演武场、远星射靶台、眷族培育栏、穹顶庇护所、议事大厅。
...
2. 调试工具：刷怪、加经验、加遗物、查看modifier。
3. 性能预算：实体数量、投射物数量、粒子数量、UI刷新频率。
4. AI协作规范：文件命名、模块边界、禁止跨模块硬改数据。
