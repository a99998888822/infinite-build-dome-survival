...
| 50 | [阻滞配重石](D:/project/useless/resources/infinite-build-dome-survival/augmentations_list.md:60) | 控制强度 + 6（[配置](D:/project/useless/resources/infinite-build-dome-survival/data_config/relics.json:1046)） | 属性+6一致；当前控制强度主要作用于电火花连锁跳数，见 S07。 |
